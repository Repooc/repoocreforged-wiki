...
class PageBackground {
  ...
  private initBackground = () => {
    let text: string = 'Repooc Reforged'.toLowerCase().split(' | ')[0].replace(/\s/g, '_');
    ...
    for(let i = 0; i < lines; i++) {
      for(let j = 0; j < letters; j++) {
        ...
        // this.baseCtx.fillStyle = 'rgba(255, 255, 255, 0.01)'; // Color of non animated text on background
        this.baseCtx.fillStyle = 'rgba(1, 245, 147, 0.01)'; // Color of non animated text on background
