...
### Current Version
<img src="https://img.shields.io/github/v/tag/repooc/ElvUI_KeybindDisplay?style=for-the-badge&label=%20&color=A330C9" alt="version" data-zoom-off />
...
### Configuration
<FluidGrid minColumnWidth="20rem">
  <img src="https://cdn-images.repoocreforged.dev/KeybindDisplay/Config_Remove_ElvUI_Short_Text.png" alt="Example Showing Removed ElvUI Short Text" />
  <img src="https://cdn-images.repoocreforged.dev/KeybindDisplay/Config_Use_ElvUI_Short_Text.png" alt="Example Showing Using ElvUI Short Text" />
</FluidGrid>
